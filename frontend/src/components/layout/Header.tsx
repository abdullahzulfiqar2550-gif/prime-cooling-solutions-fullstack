        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="flex items-center gap-2">
              <Image src="/logo.png" alt="Prime Cooling Solutions Logo" width={40} height={40} className="rounded-md" />
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link
              href="/book"
              className="block w-full text-center mt-4 px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-slate-900 bg-cyan-400 hover:bg-cyan-500"
              onClick={() => setIsOpen(false)}
            >
              Book Online
            </Link>
